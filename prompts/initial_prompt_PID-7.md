...
If a pipe-path placement map is provided, it shows a **guide** for where the piping should be placed on the Donor Image.
...
- Preserve the donor fabric weave/texture and micro-contrast; do not smooth, blur, or repaint texture.
- No halos, glow, or edge darkening around the piping; keep the transition clean and natural.
- Do not alter color outside the piping area; no spill or feather beyond the mask.
...
Quality Requirements: Do not add smudges, stains, blotches, blurs or halos on the cushions. Preserve the donor fabric texture and keep edges clean and realistic.
